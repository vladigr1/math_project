...
הצגה כיצד לקבל פתרון ממטריצת השכנויות.
\begin{english}
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
...
אחת התוצאות המענינות היא לראות השווה זמני ריצה בין שתי אלגוריתמים.
\begin{english}
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
...
קוד זה מציג מספר הפתרונות שיש על לוחות 
$m\times n$ 
כאשר 
$m,n \le 9$.
\begin{english}
...
קוד זה מציג כל הפתרונות עבור לוח בגודל
$m\times n$.
\begin{english}
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
